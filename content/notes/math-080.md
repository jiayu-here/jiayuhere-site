---
title: "Lecture 11：向量与向量组的线性相关性"
slug: math-080
description: "考研数学学习笔记：Lecture 11：向量与向量组的线性相关性。保留原始公式、图示与例题。"
category: "考研数学"
tags: ["考研数学", "线性代数", "向量组"]
---
...
- 举例： 
	- 三维空间中，两个线性无关的向量张成的空间：就是这两个向量缩放（乘法）再相加（加法）得到的所有可能的向量；
		- 图示： ![Pasted image 20240625184520](/assets/notes/ea032cb9a6dc-Pasted-image-20240625184520.png)
