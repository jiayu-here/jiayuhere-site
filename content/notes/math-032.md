...
**单调增和单调减**
- 导数和单调增减的关系
	- ![Pasted image 20240113174945](/assets/notes/4e2a62d3de45-Pasted-image-20240113174945.png)
...
### 1.2.1 凹凸性的基本概念
##### **定义**：凹凸的定义
> <font color="#ccc1d9">描述：</font> $\text{设函数 }f(x)\text{ 在区间 }I\text{ 上连续。如果对 }I\text{ 上任意两点 }x_1,x_2$
...
- 几何意义
	- 凹
		- ![Pasted image 20240113182849](/assets/notes/ff516b6bdb93-Pasted-image-20240113182849.png)
		- 其斜率在增加，即一阶导数在增加 -> 二阶导数大于零；
	- 凸
		- ![Pasted image 20240113182901](/assets/notes/9a5688f060e1-Pasted-image-20240113182901.png)
...
- 推导结论
	...
	- ![Pasted image 20240113184015](/assets/notes/48abac8b1ee4-Pasted-image-20240113184015.png)
	- 即：**拐点为二阶导数等于零的点**；
