...
slug: math-033
description: "考研数学学习笔记：Lecture 25：函数的极值与最值。保留原始公式、图示与例题。"
category: "数学"
date: 2024-01-14
...
**解释**
- 几何
	- 分别为情况一和情况二： ![Pasted image 20240114162335](/assets/notes/aeb6b52d15a5-Pasted-image-20240114162335.png)
- 优势
...
- 解析
	- 直接法：
		- 由于 $\lim_{x\to0}\frac{f(x)}{1-\cos x}=2$，并且 $1-\cos x$ 在 $x=0$ 附近大于 0 `->` 所以在 0 点附近，$f(x)>0$；
